...
module gpu_fifo_adapter #(
  ...
  input  wire [ADDR_W-1:0]  req_addr2,
  input  wire [ADDR_W-1:0]  req_addr3,
  input  wire [63:0]        req_wdata0,
  input  wire [63:0]        req_wdata1,
  input  wire [63:0]        req_wdata2,
  input  wire [63:0]        req_wdata3,

  output reg                rsp_valid,
  output reg  [63:0]        rsp_rdata0,
  output reg  [63:0]        rsp_rdata1,
  output reg  [63:0]        rsp_rdata2,
  output reg  [63:0]        rsp_rdata3,
  output wire               busy,
  ...
  reg [1:0]        state;
  reg              req_we_r;
  reg [3:0]        req_lane_mask_r;
  reg [1:0]        lane_idx_r;
  reg [ADDR_W-1:0] req_addr0_r;
  reg [ADDR_W-1:0] req_addr1_r;
  reg [ADDR_W-1:0] req_addr2_r;
  reg [ADDR_W-1:0] req_addr3_r;
  reg [63:0]       req_wdata0_r;
  reg [63:0]       req_wdata1_r;
  reg [63:0]       req_wdata2_r;
  reg [63:0]       req_wdata3_r;
    ...
    begin
      case (curr)
        2'd0: begin
          ...
          else if (mask[3]) next_lane = 2'd3;
          else next_lane = 2'd0;
        end
        2'd1: begin
          if (mask[2]) next_lane = 2'd2;
          else if (mask[3]) next_lane = 2'd3;
          else next_lane = 2'd0;
        end
        2'd2: begin
          if (mask[3]) next_lane = 2'd3;
          else next_lane = 2'd0;
        end
        default: begin
          next_lane = 2'd0;
  ...
  function is_last_lane;
    ...
    begin
      case (curr)
        2'd0: is_last_lane = ~(mask[1] | mask[2] | mask[3]);
        2'd1: is_last_lane = ~(mask[2] | mask[3]);
        2'd2: is_last_lane = ~mask[3];
        default: is_last_lane = 1'b1;
      endcase
    end
  endfunction
  ...
  always @(*) begin
    ...
    if (state == ST_ISSUE && proc_active) begin
      ...
      case (lane_idx_r)
        ...
        2'd2: begin
          proc_mem_addr = req_addr2_r;
          proc_mem_wdata = req_wdata2_r;
        end
        default: begin
          proc_mem_addr = req_addr3_r;
          proc_mem_wdata = req_wdata3_r;
        end
      endcase
    end
  end
  ...
  always @(posedge clk) begin
    if (rst) begin
      state <= ST_IDLE;
      req_we_r <= 1'b0;
      req_lane_mask_r <= 4'd0;
      lane_idx_r <= 2'd0;
      req_addr0_r <= {ADDR_W{1'b0}};
      req_addr1_r <= {ADDR_W{1'b0}};
      req_addr2_r <= {ADDR_W{1'b0}};
      req_addr3_r <= {ADDR_W{1'b0}};
      req_wdata0_r <= 64'd0;
      req_wdata1_r <= 64'd0;
      req_wdata2_r <= 64'd0;
      req_wdata3_r <= 64'd0;
        ...
        case (state)
          ST_IDLE: begin
            if (req_valid) begin
              ...
              req_addr2_r <= req_addr2;
              req_addr3_r <= req_addr3;
              req_wdata0_r <= req_wdata0;
              req_wdata1_r <= req_wdata1;
              req_wdata2_r <= req_wdata2;
              req_wdata3_r <= req_wdata3;
              rsp_rdata0 <= 64'd0;
              rsp_rdata1 <= 64'd0;
              rsp_rdata2 <= 64'd0;
              rsp_rdata3 <= 64'd0;
              if (req_lane_mask == 4'd0)
                state <= ST_RESP;
              else
                state <= ST_ISSUE;
            end
          ...
          ST_WAIT: begin
            if (proc_mem_rvalid) begin
              case (lane_idx_r)
                2'd0: rsp_rdata0 <= proc_mem_rdata;
                2'd1: rsp_rdata1 <= proc_mem_rdata;
                2'd2: rsp_rdata2 <= proc_mem_rdata;
                default: rsp_rdata3 <= proc_mem_rdata;
              endcase
...
module gpu_top_fifo_if #(
  ...
  output wire [3:0]             mem_lane_mask,
  output wire [MEM_AW-1:0]      mem_addr0,
  output wire [MEM_AW-1:0]      mem_addr1,
  output wire [MEM_AW-1:0]      mem_addr2,
  output wire [MEM_AW-1:0]      mem_addr3,
  output wire [63:0]            mem_wdata0,
  output wire [63:0]            mem_wdata1,
  output wire [63:0]            mem_wdata2,
  output wire [63:0]            mem_wdata3,

  input  wire                   mem_rsp_valid,
  input  wire [63:0]            mem_rdata0,
  input  wire [63:0]            mem_rdata1,
  input  wire [63:0]            mem_rdata2,
  input  wire [63:0]            mem_rdata3,
  ...
  wire [MEM_AW-1:0] ex_addr0, ex_addr1, ex_addr2, ex_addr3;
  ...
  wire [MEM_AW-1:0] mm_addr0, mm_addr1, mm_addr2, mm_addr3;
...
module gpu_mm_stage #(
  ...
  output wire [DMEM_AW-1:0] mem_addr2,
  output wire [DMEM_AW-1:0] mem_addr3,
  output wire [63:0] mem_wdata0,
  output wire [63:0] mem_wdata1,
  output wire [63:0] mem_wdata2,
  output wire [63:0] mem_wdata3,
  ...
  output reg  [63:0] dmem_rdata2,
  output reg  [63:0] dmem_rdata3,
  ...
  reg [DMEM_AW-1:0] addr0_r, addr1_r, addr2_r, addr3_r;
  reg [63:0] wdata0_r, wdata1_r, wdata2_r, wdata3_r;
  reg [63:0] res0_r, res1_r, res2_r, res3_r;
  reg        req_we_r;
  ...
  assign mem_addr2 =
      (state == ST_IDLE) ? in_addr2 : addr2_r;
  assign mem_addr3 =
      (state == ST_IDLE) ? in_addr3 : addr3_r;
  ...
  assign mem_wdata2 =
      (state == ST_IDLE) ? in_store2 : wdata2_r;
  assign mem_wdata3 =
      (state == ST_IDLE) ? in_store3 : wdata3_r;
  ...
  assign out_res2 =
      (state == ST_RESP) ? res2_r : in_res2;
  assign out_res3 =
      (state == ST_RESP) ? res3_r : in_res3;
  ...
  always @(posedge clk) begin
    if (rst) begin
      ...
      addr2_r <= {DMEM_AW{1'b0}};
      addr3_r <= {DMEM_AW{1'b0}};
      wdata0_r <= 64'd0;
      wdata1_r <= 64'd0;
      wdata2_r <= 64'd0;
      wdata3_r <= 64'd0;
      ...
      case (state)
        ...
        ST_WAIT_RSP: begin
          if (mem_rsp_valid) begin
            ...
            dmem_rdata2 <= mem_rdata2;
            dmem_rdata3 <= mem_rdata3;
            state <= ST_RESP;
          end
        end
