...
REG_DEFINES_PATH="$ROOT_DIR/sw/reg_defines_v7.h"
mkdir -p "$MOCK_BIN_DIR" "$MOCK_STATE_DIR" "$ANNCTL_STATE_DIR"
: > "$MOCK_LOG"

assert_file_exists "$REG_DEFINES_PATH" "missing sw/reg_defines_v7.h"
...
bash "$ROOT_DIR/scripts/check/examples_binary_mnist.sh"
