...
module user_pre_debug_tb;
  ...
  localparam integer WORD0_HI_WORD_INDEX = 3;
  localparam integer WORD0_LO_WORD_INDEX = 4;
  localparam integer WORD1_HI_WORD_INDEX = 5;
  localparam integer WORD1_LO_WORD_INDEX = 6;
  ...
  task expect_zero_snapshot;
    begin
      ...
      expect_local_reg_read(WORD1_LO_WORD_INDEX, 32'h0000_0000, "word1 lo should reset to zero");
    end
  endtask
  ...
  task test_capture_first_packet_and_lock;
    begin
      ...
      expect_local_reg_read(STATUS_WORD_INDEX, 32'h0001_0205, "status should show valid two-word capture");
      ...
      expect_local_reg_read(WORD1_HI_WORD_INDEX, 32'h5555_6666, "word1 hi mismatch");
      expect_local_reg_read(WORD1_LO_WORD_INDEX, 32'h7777_8888, "word1 lo mismatch");

      drive_word(64'haaaa_bbbb_cccc_dddd, 8'hff);
      drive_word(64'heeee_ffff_1111_2222, 8'h00);
      drive_word(64'h3333_4444_5555_6666, 8'h40);

      expect_local_reg_read(STATUS_WORD_INDEX, 32'h0001_0205, "second packet must not overwrite locked snapshot");
  ...
  task test_clear_rearms_short_packet_capture;
    begin
      ...
      expect_local_reg_read(STATUS_WORD_INDEX, 32'h0001_0205, "status should show two-word capture");
      expect_local_reg_read(CTRL_PACK_0_WORD_INDEX, 32'h0000_00ff, "short packet ctrl pack mismatch");
      ...
      expect_local_reg_read(WORD1_LO_WORD_INDEX, 32'h1516_1718, "short packet word1 lo mismatch");
    end
  endtask
