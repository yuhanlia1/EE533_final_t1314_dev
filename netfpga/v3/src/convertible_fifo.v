...
*/
  ...
  input  [DATA_WIDTH-1:0]           gpu_mem0_wdata,
  output [DATA_WIDTH-1:0]           gpu_mem0_rdata,
  output                            gpu_mem0_rvalid,
  input                             gpu_mem1_en,
  input                             gpu_mem1_we,
  input  [FIFO_ADDR_WIDTH-1:0]      gpu_mem1_addr,
  input  [DATA_WIDTH-1:0]           gpu_mem1_wdata,
  output [DATA_WIDTH-1:0]           gpu_mem1_rdata,
  output                            gpu_mem1_rvalid,
  output                            gpu_proc_active,

  input                             dbg_mem_en,
  input  [FIFO_ADDR_WIDTH-1:0]      dbg_mem_addr,
  output [DATA_WIDTH-1:0]           dbg_mem_rdata,
  output [CTRL_WIDTH-1:0]           dbg_mem_rctrl,
...
*/
  ...
  dropfifo #(
    ...
    .dbg_mem_rctrl(dbg_mem_rctrl),
    .dbg_mem_rvalid(dbg_mem_rvalid),
    .dbg_state(dbg_state),
    .dbg_pkt_len(dbg_pkt_len),
