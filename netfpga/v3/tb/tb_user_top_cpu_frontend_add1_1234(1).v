...
module tb_user_top_cpu_frontend_add1_1234_2lane;
  ...
  task send_packet_1234;
    begin
      ...
      @(negedge clk); in_wr = 1'b1; in_ctrl = 8'hff; in_data = 64'd1; @(posedge clk);
      @(negedge clk); in_ctrl = 8'h00; in_data = 64'd2; @(posedge clk);
      @(negedge clk); in_ctrl = 8'h00; in_data = 64'd3; @(posedge clk);
      @(negedge clk); in_ctrl = 8'h00; in_data = 64'd4; @(posedge clk);
      @(negedge clk); in_wr = 1'b0; in_ctrl = 8'h00; in_data = 64'd0;
    end
  endtask
  ...
  always @(posedge clk) begin
    if (reset) begin
      ...
      if (prev_owner_gpu != dut.proc_owner_gpu_live)
        $display("[%0t] proc_owner_gpu_live -> %b", $time, dut.proc_owner_gpu_live);
      ...
      prev_owner_gpu <= dut.proc_owner_gpu_live;
  ...
  initial begin
    $dumpfile("tb_user_top_cpu_frontend_add1_1234_2lane.vcd");
    $dumpvars(0, tb_user_top_cpu_frontend_add1_1234_2lane);
    ...
    if (dut.proc_owner_gpu_live !== 1'b0) begin
