...
module tb_user_top_cpu_modify_2lane;
    ...
    begin
      ...
      for (k = 0; k < limit; k = k + 1) begin
        ...
        if (dut.u_fifo.hold_valid == 1'b0 &&
            ...
            dut.u_fifo.gpu_proc_active == 1'b0) begin
          ok = 1'b1;
          k = limit;
        end
      end
  ...
  task check_pkt_unchanged;
    begin
      ...
      if (out_cap[0] !== {8'hff,64'h1111111111111111}) begin $display("FAIL: word0 mismatch"); $finish; end
      if (out_cap[1] !== {8'h00,64'h2222222222222222}) begin $display("FAIL: word1 mismatch"); $finish; end
      if (out_cap[2] !== {8'h00,64'h3333333333333333}) begin $display("FAIL: word2 mismatch"); $finish; end
      if (out_cap[3] !== {8'h00,64'h4444444444444444}) begin $display("FAIL: word3 mismatch"); $finish; end
      if (out_cap[4] !== {8'h00,64'h5555555555555555}) begin $display("FAIL: word4 mismatch"); $finish; end
      if (out_cap[5] !== {8'h00,64'h6666666666666666}) begin $display("FAIL: word5 mismatch"); $finish; end
    end
  endtask
  ...
  task check_pkt_word1_add1;
    begin
      ...
      if (out_cap[0] !== {8'hff,64'h1111111111111111}) begin $display("FAIL: word0 mismatch"); $finish; end
      if (out_cap[1] !== {8'h00,64'h2222222222222223}) begin $display("FAIL: modified word1 mismatch, got %h", out_cap[1][63:0]); $finish; end
      if (out_cap[2] !== {8'h00,64'h3333333333333333}) begin $display("FAIL: word2 mismatch"); $finish; end
      if (out_cap[3] !== {8'h00,64'h4444444444444444}) begin $display("FAIL: word3 mismatch"); $finish; end
      if (out_cap[4] !== {8'h00,64'h5555555555555555}) begin $display("FAIL: word4 mismatch"); $finish; end
      if (out_cap[5] !== {8'h00,64'h6666666666666666}) begin $display("FAIL: word5 mismatch"); $finish; end
  ...
  initial begin
    $dumpfile("tb_user_top_cpu_modify_2lane.vcd");
    $dumpvars(0, tb_user_top_cpu_modify_2lane);
