...
class BoardDebugUdpPacketTests(unittest.TestCase):
    ...
    def test_boardctl_capture_workflow_includes_time_window_script(self) -> None:
        ...
        self.assertIn("sleep 2.5", scripts["nf1_capture_offload_batch_time_window.sh"])
        self.assertIn("offload_batch_time_window.cap", scripts["nf1_capture_offload_batch_time_window.sh"])
