...
module user_top_tb;
  ...
  task init_ann_engine;
    ...
    begin
      ...
      if (dut.hw_engine_status[0] !== 1'b1)
...
`endif
    ...
    start_test("tc14_ann_ethertype_offload_smoke");
    init_ann_engine;
    ...
    send_packet(-1, 0, 1);
    expect_cpu_replay_matches_tx(50000);
    finish_test;

    start_test("tc15_ann_ethertype_mixed_with_bypass");
    ...
    start_test("tc16_ann_wrong_magic_bypasses");
    auto_expect_tx_words = 1'b1;
    build_ann_ethertype_packet_ex(4, 4, 16'h0001, 16'h0008, 16'h9abc, 2, 16'hbeef, 16'h0000);
    send_packet(-1, 0, 1);
    finish_test;

    start_test("tc17_ann_truncated_payload_status");
    auto_expect_tx_words = 1'b0;
