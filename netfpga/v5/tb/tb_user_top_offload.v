...
module tb_user_top_offload;
  ...
  task expect_ann_result_packet_words;
    ...
    begin
      ...
      result_frame_bytes[26] = exp_result_a[15:8];
      result_frame_bytes[27] = exp_result_a[7:0];
      result_frame_bytes[28] = exp_result_b[15:8];
      result_frame_bytes[29] = exp_result_b[7:0];
...
`endif
    ...
    auto_expect_tx_words = 1'b0;
    build_ann_ethertype_packet(8, 16'h0004, 16'h0001, 16'h7777, 9);
    ...
    auto_expect_tx_words = 1'b0;
    build_ann_ethertype_packet(8, 16'h0005, 16'h0004, 16'h8888, 10);
    ...
    auto_expect_tx_words = 1'b0;
    build_ann_ethertype_packet(8, 16'h0006, 16'h0002, 16'h9999, 11);
    ...
    auto_expect_tx_words = 1'b0;
    build_ann_ethertype_packet(8, 16'h0007, 16'h0008, 16'haaaa, 12);
