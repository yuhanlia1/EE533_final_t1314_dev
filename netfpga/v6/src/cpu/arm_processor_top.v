module arm_64_top #(
  ...
  wire [REG_ADDR_WIDTH-1:0]  ex1_WReg1;
  ...
  decode_stage1 #(
    ...
    .sw_rf_we                (1'b0),
    .sw_rf_re                (1'b0),
    .sw_rf_addr              ({REG_ADDR_WIDTH{1'b0}}),
    .sw_rf_data              ({DATA_WIDTH{1'b0}}),
    ...
    .wb_waddr                (wb1_WReg1),
    .wb_wdata                (wb1_d_out),
    .wb_thread_id            (wb1_thread_id_out),
  ...
  ex_stage1 #(
    ...
    .w_mem_en                (id1_w_mem_en),
    .w_reg_en                (id1_w_reg_en),
    .R1_in                   (id1_R1_out),
    .R2_in                   (id1_R2_out),
    .WReg1                   (id1_WReg1),
    .thread_id               (id1_thread_id_out),
    .immediate_en            (id1_alu_src),
    .immediate               (id1_ext),
    .branch_en               (id1_branch_en),
    .mov_lsl_flag            (id1_mov_lsl_flag),
    .mov_lsl_flag_imm_en     (id1_mov_lsl_flag_imm_en),
    .pc_next                 (id1_pc_next_out),
    .alu_ctrl                (id1_alu_ctrl),
    .lw_en                   (id1_lw_en),
    .cond                    (id1_cond),
    .imm_24                  (id1_imm_24),
    .ld_ptrs                 (id1_ld_ptrs),
  ...
  mem_stage #(
    ...
    .sw_d_mem_addr     (sw_d_mem_addr[MEM_ADDR_WIDTH-1:0]),
    .sw_d_mem_data     ({DATA_WIDTH{1'b0}}),
