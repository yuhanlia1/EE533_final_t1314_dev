...
module user_pre_debug #(
  ...
  localparam integer NUM_DEBUG_HW_REGS = 15;
  localparam integer SNAPSHOT_WORDS = 6;
  ...
  reg  [2:0]  capture_index_reg;
  reg  [7:0]  ctrl_word0_reg;
  reg  [7:0]  ctrl_word1_reg;
  reg  [7:0]  ctrl_word2_reg;
  reg  [7:0]  ctrl_word3_reg;
  reg  [7:0]  ctrl_word4_reg;
  reg  [7:0]  ctrl_word5_reg;
  reg  [63:0] data_word0_reg;
  reg  [63:0] data_word1_reg;
  reg  [63:0] data_word2_reg;
  reg  [63:0] data_word3_reg;
  reg  [63:0] data_word4_reg;
  reg  [63:0] data_word5_reg;
  ...
  assign debug_hardware_regs = {
    data_word5_reg[31:0],
    data_word5_reg[63:32],
    data_word4_reg[31:0],
    data_word4_reg[63:32],
    data_word3_reg[31:0],
    data_word3_reg[63:32],
    data_word2_reg[31:0],
    data_word2_reg[63:32],
    data_word1_reg[31:0],
    data_word1_reg[63:32],
    data_word0_reg[31:0],
    data_word0_reg[63:32],
    {16'h0000, ctrl_word5_reg, ctrl_word4_reg},
    {ctrl_word3_reg, ctrl_word2_reg, ctrl_word1_reg, ctrl_word0_reg},
  ...
  task store_snapshot_word;
    ...
    begin
      case (word_index)
        ...
        3'd2: begin
          data_word2_reg <= word_data;
          ctrl_word2_reg <= word_ctrl;
        end
        3'd3: begin
          data_word3_reg <= word_data;
          ctrl_word3_reg <= word_ctrl;
        end
        3'd4: begin
          data_word4_reg <= word_data;
          ctrl_word4_reg <= word_ctrl;
        end
        default: begin
          data_word5_reg <= word_data;
          ctrl_word5_reg <= word_ctrl;
        end
      endcase
    end
  endtask
  ...
  always @(posedge clk or posedge reset) begin
    if (reset) begin
      ...
      capture_index_reg  <= 3'd0;
      ctrl_word0_reg     <= 8'h00;
      ctrl_word1_reg     <= 8'h00;
      ctrl_word2_reg     <= 8'h00;
      ctrl_word3_reg     <= 8'h00;
      ctrl_word4_reg     <= 8'h00;
      ctrl_word5_reg     <= 8'h00;
      data_word0_reg     <= 64'h0000_0000_0000_0000;
      data_word1_reg     <= 64'h0000_0000_0000_0000;
      data_word2_reg     <= 64'h0000_0000_0000_0000;
      data_word3_reg     <= 64'h0000_0000_0000_0000;
      data_word4_reg     <= 64'h0000_0000_0000_0000;
      data_word5_reg     <= 64'h0000_0000_0000_0000;
    end
    else begin
      ...
      if (debug_clear_pulse) begin
        ...
        if (!capture_active_reg) begin
          if (mon_ctrl != {CTRL_WIDTH{1'b0}}) begin
            ...
            capture_done_reg   <= 1'b0;
            capture_index_reg  <= 3'd1;
            word_count_reg     <= 8'd1;
            store_snapshot_word(3'd0, mon_data, mon_ctrl);
          ...
          word_count_reg <= {5'b0, capture_index_reg} + 8'd1;
          ...
          if ((capture_index_reg == (SNAPSHOT_WORDS - 1)) ||
            ...
            capture_index_reg <= capture_index_reg + 3'd1;
          end
        end
      end
    end
