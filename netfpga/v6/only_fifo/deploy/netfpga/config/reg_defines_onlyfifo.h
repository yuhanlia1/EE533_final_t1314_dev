 ...
 * Project: Pipeline (onlyfifo)
 * Description: Simple 5 stage pipeline
 *
 ********************************************************/

#ifndef _REG_DEFINES_ONLYFIFO_
#define _REG_DEFINES_ONLYFIFO_
...
#define DEVICE_PROJ_DIR    "onlyfifo"
...
// Description: Debug registers for only_fifo user_top
// File: projects/onlyfifo/include/user_top.xml
...
// Name: user_pre_debug (USER_PRE_DEBUG)
// Description: Sticky pre-user_top debug snapshot registers for only_fifo
// File: projects/onlyfifo/include/user_pre_debug.xml
